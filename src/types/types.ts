...
// Категории расходов — сгруппированы по смыслу (закуп/фиксированные/переменные),
// но хранятся плоским списком; какие из них считаются себестоимостью (COGS)
// см. COGS_CATEGORIES ниже — это важно для расчёта чистой прибыли.
export const EXPENSE_CATEGORIES = [
  'Закуп дверей', 'Закуп фурнитуры/комплектующих',
  'Аренда', 'Коммунальные услуги', 'Связь/интернет', 'Абонентские платежи (ПО/CRM/бухгалтерия)',
  'Реклама/маркетинг', 'Расходники (упаковка, канцелярия)', 'Ремонт/обслуживание салона',
  'Топливо/ГСМ', 'Аренда транспорта', 'Грузчики/курьеры',
  'Гарантия/возврат', 'Банковская комиссия', 'Налоги',
  'Монтаж', 'прочее',
] as const;

// Категории, которые считаются себестоимостью товара (COGS) — вычитаются из
// выручки первыми, до операционных расходов, при расчёте чистой прибыли.
export const COGS_CATEGORIES = ['Закуп дверей', 'Закуп фурнитуры/комплектующих'] as const;
